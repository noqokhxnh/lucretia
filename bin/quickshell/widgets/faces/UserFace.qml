            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    ClickButton {
                        ...
                        onClicked: Quickshell.execDetached(["bash", Quickshell.env("HOME") + "/.config/niri/bin/qs_manager.sh", "toggle", "guide"])
                    }
                    ...
                    ClickButton {
                        ...
                        onClicked: {
                            Quickshell.execDetached(["bash", Quickshell.env("HOME") + "/.config/niri/bin/lock.sh"]);
                        }
                    }
                }
            }
