...
Item {
    ...
    Keys.onReturnPressed: {
        if (currentTab === 2) { 
            ...
            Quickshell.execDetached(["bash", Quickshell.env("HOME") + "/.config/niri/bin/qs_manager.sh", "toggle", target]);
            event.accepted = true;
        }
    }
                            ...
                            Column {
                                ...
                                Rectangle {
                                    ...
                                    MouseArea { 
                                        ...
                                        onClicked: {
                                            if (index === 0) {
                                                Quickshell.execDetached(["bash", Quickshell.env("HOME") + "/.config/niri/bin/qs_manager.sh", "toggle", "settings"]);
                                            } else {
        ...
        Item {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Row {
                                ...
                                spacing: root.s(1)
                                Repeater {
                                    model: [ { l: "n", c: root.red }, { l: "o", c: root.peach }, { l: "q", c: root.yellow }, { l: "o", c: root.green }, { l: "k", c: root.sapphire }, { l: "h", c: root.blue }, { l: "x", c: root.mauve }, { l: "n", c: root.pink }, { l: "h", c: root.peach } ]
                                    Text { 
                                        text: modelData.l
                                        font.family: "JetBrains Mono"
                                        font.weight: Font.Black
                        ...
                        MouseArea { 
                            ...
                            hoverEnabled: true
                            cursorShape: Qt.PointingHandCursor
                            onClicked: Quickshell.execDetached(["xdg-open", "https://github.com/noqokhxnh/lucretia"]) 
                        }
                    }
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            MouseArea { 
                                ...
                                hoverEnabled: true
                                cursorShape: Qt.PointingHandCursor
                                onClicked: Quickshell.execDetached(["bash", Quickshell.env("HOME") + "/.config/niri/bin/qs_manager.sh", "toggle", modulesDataModel.get(root.selectedModuleIndex).target]) 
                            }
                        }
                    }
                    ...
                    ListView {
                        ...
                        delegate: Rectangle {
                            ...
                            MouseArea { 
                                ...
                                onDoubleClicked: { 
                                    root.selectedModuleIndex = index; 
                                    Quickshell.execDetached(["bash", Quickshell.env("HOME") + "/.config/niri/bin/qs_manager.sh", "toggle", model.target]) 
                                } 
                            }
                        }
                    }
            ...
            Item {
                ...
                RowLayout {
                    ...
                    Repeater {
                        model: [
                            { name: "My Config", icon: "", color: "blue", url: "https://github.com/noqokhxnh/lucretia" },
                            { name: "Profile", icon: "", color: "mauve", url: "https://github.com/noqokhxnh" },
                            { name: "Wallpapers", icon: "", color: "peach", url: "https://github.com/noqokhxnh/lucretia" }
                        ]
