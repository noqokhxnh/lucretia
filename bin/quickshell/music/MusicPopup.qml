...
Item {
    ...
    function applyPresetOptimistically(presetName) {
        ...
        if (presets[presetName]) {
            ...
            execCmd(`$HOME/.config/niri/bin/quickshell/music/music_backend preset ${presetName}`);
        }
    }
    ...
    Timer {
        ...
        interval: 2000
        onTriggered: root.userIsSkipping = false
    }

    function fetchEq() {
        Components.QsDaemonClient.sendRequest("music", "get_eq", {}, function(data) {
            if (data) {
                root.eqData = data;
            }
        });
    ...
    Component.onCompleted: {
        root.musicData = Components.QsDaemonClient.musicState;
        root.fetchEq();
    }
                    ...
                    ColumnLayout {
                            ...
                            Slider {
                                ...
                                Connections {
                                    ...
                                    function onMusicDataChanged() {
                                        if (!progBar.pressed && !root.userIsSeeking && !root.userIsSkipping) {
                                ...
                                Behavior on value {
                                    enabled: !progBar.pressed && !root.userIsSeeking && !root.userIsSkipping
                                ...
                                onPressedChanged: {
                                    if (pressed) {
                                        ...
                                        root.execCmd(`$HOME/.config/niri/bin/quickshell/music/music_backend seek ${value.toFixed(2)} ${root.musicData.length}`);
                        ...
                        RowLayout {
                            ...
                            MouseArea {
                                ...
                                onClicked: {
                                    if (root.musicData.title !== "Loading...") {
                                        root.skippedTitle = root.musicData.title;
                                    }
                                    root.userIsSkipping = true;
                                    progBar.value = 0;
                                    ...
                                    root.musicData = temp;
                                    root.execCmd("$HOME/.config/niri/bin/quickshell/music/music_backend prev");
                                }
                            ...
                            MouseArea {
                                ...
                                onClicked: {
                                    ...
                                    root.musicData = temp;
                                    root.execCmd("$HOME/.config/niri/bin/quickshell/music/music_backend play-pause");
                                }
                            ...
                            MouseArea {
                                ...
                                onClicked: {
                                    ...
                                    temp.positionStr = "00:00";
                                    root.musicData = temp;
                                    root.execCmd("$HOME/.config/niri/bin/quickshell/music/music_backend next");
                                }
                                Text { anchors.centerIn: parent; text: ""; color: parent.pressed ? root.text : root.overlay2; font.family: "Iosevka Nerd Font"; font.pixelSize: root.s(24) }
                            }
                        }
                            ...
                            MouseArea {
                                ...
                                onClicked: {
                                    if (root.eqData.pending) {
                                        ...
                                        root.triggerEqLightning();
                                        root.execCmd("$HOME/.config/niri/bin/quickshell/music/music_backend apply");
                                    }
                                }
                            }
                        }
                                        ...
                                        Slider {
                                            ...
                                            onPressedChanged: {
                                                if (!pressed) {
                                                    ...
                                                    root.execCmd(`$HOME/.config/niri/bin/quickshell/music/music_backend set_band ${modelData.idx} ${Math.round(value)}`);
                                                }
                                            }
