...
ShellRoot {
    ...
    WlSessionLock {
        ...
        WlSessionLockSurface {
            ...
            // Solid black foundation to prevent white flashes during initialization
            Rectangle {
                anchors.fill: parent
                color: "black"
                z: -999
            ...
            Item {
                ...
                Timer { interval: 2500; running: true; repeat: true; triggeredOnStart: true; onTriggered: kbPoller.running = true }
                ...
                ScreencopyView {
                    ...
                    paintCursor: false
                    z: -15
                    opacity: 1.0 - screenRoot.introState
                }
                ...
                MultiEffect {
                    ...
                    blur: screenRoot.introState * (screenRoot.inputActive ? 1.25 : 1.0)
                ...
                Item {
                    ...
                    ColumnLayout {
                        id: clockModule
                    anchors.centerIn: parent
                    anchors.verticalCenterOffset: screenRoot.inputActive ? (-140 * screenRoot.sc) : (-40 * screenRoot.sc)
                    spacing: -10 * screenRoot.sc
                    
                    opacity: screenRoot.inputActive ? 0.0 : 1.0
                    scale: screenRoot.inputActive ? 0.8 : (screenRoot.isPlayingIntro ? 1.0 : breathingAnim.val)
                    ...
                    QtObject {
                        ...
                        SequentialAnimation on val {
                            ...
                            running: !screenRoot.inputActive && !screenRoot.isPlayingIntro
                            NumberAnimation { from: 1.0; to: 1.02; duration: 4000; easing.type: Easing.InOutSine }
                            NumberAnimation { from: 1.02; to: 1.0; duration: 4000; easing.type: Easing.InOutSine }
                        }
                    }
                    ...
                    Behavior on scale { NumberAnimation { duration: 400; easing.type: Easing.OutExpo } }
                        ...
                        RowLayout {
                            ...
                            Text {
                                ...
                                color: root.text
                                Behavior on color { ColorAnimation { duration: 300 } }
                                transform: Translate { y: -120 * screenRoot.sc * (1.0 - screenRoot.introState) }
                            }
                            Text {
                                text: ":"
                                font.family: "JetBrains Mono"
                                font.pixelSize: 140 * screenRoot.sc
                                font.weight: Font.Bold
                                opacity: 0.5 * screenRoot.introState
                                color: root.text
                                scale: 0.5 + (0.5 * screenRoot.introState)
                                Behavior on color { ColorAnimation { duration: 300 } }
                            }
                            Text {
                                id: clockMinutes
                    ...
                    RowLayout {
                        id: authModule
                        anchors.centerIn: parent
                        anchors.verticalCenterOffset: screenRoot.inputActive ? (-40 * screenRoot.sc) : (60 * screenRoot.sc)
                        spacing: 32 * screenRoot.sc 
                        
                        opacity: screenRoot.inputActive ? 1.0 : 0.0
                        scale: screenRoot.inputActive ? 1.0 : 0.8
                        visible: opacity > 0.01
                        ...
                        ColumnLayout {
                            ...
                            Rectangle {
                                ...
                                Behavior on border.color { ColorAnimation { duration: 150; easing.type: Easing.OutExpo } }
                ...
                Component.onCompleted: {
                    // Capture screen immediately for seamless transition
