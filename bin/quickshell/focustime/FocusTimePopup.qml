...
Item {
   ...
   // -------------------------------------------------------------------------
    ...
    readonly property string scriptsDir: Quickshell.env("HOME") + "/.config/niri/bin/quickshell/focustime"
    ...
    function requestDataUpdate() {
        let isoDate = getIsoDate(window.activeDate);
        let appFilter = window.selectedAppClass;
        Components.QsDaemonClient.sendRequest("focustime", "get_stats", { date: isoDate, app: appFilter }, function(data) {
            if (data) {
